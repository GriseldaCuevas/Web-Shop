...
/* Ajax que nos indica si el producto tiene stock en la tienda seleccionada */
function getStockInStoreByProducts(url, store_id) {
    jQuery("#stockInStoreInfo").html('');
    jQuery("#stockInStoreInfoLoader").css("display", "block");
        ...
        var request = new Ajax.Request(url,
                {
                    ...
                    onSuccess: function(transport) {
                        ...
                        jQuery("#stockInStoreInfoLoader").css("display", "none");
                        if (response.result == 'true') {
                            jQuery("#stockInStoreInfo").html(response.detalle);
                        }
                        else {
                            jQuery("#stockInStoreInfo").html(response.detalle);
                        }
